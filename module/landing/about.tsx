  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between mt-12 md:mt-[50px] space-y-8 md:space-y-0">
      <div className="w-full md:w-1/2 h-full text-center md:text-left">
        ...
        <motion.h1
          className="font-[400] font-forum text-[36px] md:text-[49px] text-[#454545]"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}
          viewport={{ once: true, amount: 0.2 }} // Trigger once the element is 20% in view
      ...
      <div className="w-full md:w-1/2">
        <motion.div
          className="description font-[400] text-[16px] md:text-[20px] text-[#454545] text-center md:text-left"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}
          viewport={{ once: true, amount: 0.2 }} // Trigger once the element is 20% in view
        ...
        <motion.div
          className="cta my-8 md:my-[50px] flex justify-center md:justify-start"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}
          viewport={{ once: true, amount: 0.2 }} // Trigger once the element is 20% in view
        >
          <a
            className="btn btn-outline rounded-3xl w-[199px] border-[#454545] text-[#454545] flex items-center justify-center space-x-2"
            href="/about-me"
          >
