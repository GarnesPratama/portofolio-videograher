      ...
      <div className="work-experience -mt-10">
        ...
        {isLoading ? (
          <div className="space-y-4">
            {[...Array(3)].map((_, index) => (
              <div key={index} className="flex flex-col lg:flex-row gap-[16px] sm:gap-[32px] justify-between mt-[24px] animate-pulse">
                <div className="w-full">
                  <div className="h-[32px] sm:h-[36px] lg:h-[44px] bg-gray-300 rounded-md"></div>
                  <div className="h-[24px] sm:h-[28px] lg:h-[32px] bg-gray-200 mt-2 rounded-md"></div>
                </div>
                <div className="w-full -mt-4 md:-mt-8 lg:mt-0 lg:text-end">
                  <div className="h-[24px] sm:h-[28px] lg:h-[32px] bg-gray-200 rounded-md"></div>
                </div>
              </div>
            ))}
          </div>
